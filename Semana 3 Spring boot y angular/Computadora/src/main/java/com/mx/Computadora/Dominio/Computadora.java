...
public class Computadora {
	...
	public Computadora(int idComputadora, String marca, String modelo, int ram, String procesador, int precio) {
		super();
	...
	public String toString() {
		return "Computadora [idComputadora=" + idComputadora + ", marca=" + marca + ", modelo=" + modelo + ", ram="
