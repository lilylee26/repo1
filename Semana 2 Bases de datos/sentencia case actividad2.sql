...
(
    CASE
    WHEN FECHA_COMPRA >= ADD_MONTHS(SYSDATE, -12) THEN 'NUEVA (MENOS DE 1 AÑO)'
    WHEN FECHA_COMPRA >= ADD_MONTHS(SYSDATE, -36) THEN 'SEMI NUEVA (1 A 3 AÑOS)'
    WHEN FECHA_COMPRA >= ADD_MONTHS(SYSDATE, -60) THEN 'ANTIGUA (3 A 5 AÑOS)'
    ELSE 'MUY ANTIGUA (MAS DE 5 AÑOS)'
    END
